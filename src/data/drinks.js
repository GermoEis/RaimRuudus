export const drinkCategories = [
  ...
  },
  {
    title: 'Kokteilid',
    price: 'alates 7 €',
    tags: ['majakokteil', 'õhtuks'],
    description: 'Lihtsad, värsked ja mereäärsesse õhtusse sobivad kokteilid.',
    items: ['Majakokteil', 'Spritz', 'Alkoholivaba kokteil'],
  },
  {
    title: 'Kangemad joogid',
    price: 'alates 5 €',
    tags: ['klassika', 'väike valik'],
    description: 'Väike valik klassikalisi jooke vastutustundlikuks nautimiseks.',
    items: ['Rumm', 'Viski', 'Liköörid'],
  },
  {
